...
class ControladorCargo:
    ...
    def listar_cargos_comuns(self):
        if (len(self.__cargos) == 1):
            print("A empresa ainda não cadastrou os cargos de funcionários comuns no sistema.")
        else:
    ...
    def abre_tela(self):
        lista_opcoes = {1: self.incluir_cargo, 2: self.alterar_cargo, 3: self.excluir_cargo, 4: self.listar_todos_cargos, 5: self.retornar}
